...
<!-- ═══════════════════════════════════════════════════════════════════════════════
     ...
     ◈ Every section header is a terminal command — because the best interfaces
       are the ones you type into.

     ◈ The moon phases represent the cycle of learning: waxing, full, waning,
       and beginning again. There is no final state — only iteration.

     ◈ The contribution graph is labeled "Constellation" because every commit
       is a star, and stars form patterns only visible from a distance.

     ◈ "Between data and decisions, I build bridges." — The mantra of every
       ML engineer who understands that models are translations, not truths.

     ◈ The color palette (#0B0F19 → #4C1D95) traces the gradient from
       deep space to the edge of a nebula — where new systems are born.

     ◈ "nc -l connect" is netcat in listen mode. The quietest way to say:
       "I'm here. Send a signal."

     ◈ If you read this far, you understand:
       Intelligence is not volume. It is resolution.
